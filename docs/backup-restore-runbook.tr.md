...
Bu runbook `@vaur94/agz-memory@0.4.2` ve SQLite schema v10 için geçerlidir.
...
Final `0.4.2` ön sürüm manifest formatlarını kabul etmez. Böyle bir yedeği onu
oluşturan ön sürümle geri yükleyin, o sürümün doctor kontrolünü çalıştırın ve
yalnız bundan sonra geri yüklenen veritabanını `0.4.2` ile yükseltin.
